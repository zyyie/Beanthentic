...
class GIAnalyzer:
    ...
    def __init__(self, uploads_dir: str | None = None):
        ...
        self._term_synonyms = {
            "manual of specifications": ["manual of specification", "mop", "specifications manual", "code of practice"],
            ...
            "product photos": ["photograph", "photographs", "product image", "product photo"],
            "roasting process": ["roasting process", "roasted coffee", "coffee roasting"],
            "farming practices": ["farming practices", "farming practice", "traditional farming"],
            "flavor profile": ["flavor profile", "taste profile", "cup profile"],
            "geographical origin": ["geographical origin", "geographical indication", "grown in lipa"],
            "distinctive quality": ["distinctive quality", "unique quality", "characteristic quality"],
